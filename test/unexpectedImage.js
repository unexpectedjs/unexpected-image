...
describe('unexpected-image', () => {
  ...
  const turtleJpegPath = pathModule.resolve(
    __dirname,
    '..',
    'testdata',
    'turtle.jpg'
  ...
  const turtleJpeg = fs.readFileSync(turtleJpegPath);

  describe('with an image provided as a Buffer instance', () => {
    it('should succeed', () => expect(turtleJpeg, 'to have metadata satisfying', {
      format: 'JPEG',
      size: {
        width: 481
      }
  ...
  describe('with an image provided as a Uint8Array instance', () => {
    it('should succeed', () => expect(new Uint8Array(turtleJpeg), 'to have metadata satisfying', {
      format: 'JPEG',
      size: {
        width: 481
      }
  ...
  describe('with an image provided as a file name', () => {
    it('should succeed', () => expect(turtleJpegPath, 'to have metadata satisfying', {
      format: 'JPEG',
      size: {
        width: 481
      }
  ...
  it('should identify an image despite of a wrong extension', () => expect(
  ...
  it('should fail with an error message if the file type is unsupported', () => expect(
    expect(
  ...
  it('should support identifying an image given by a data: url', () => expect(
